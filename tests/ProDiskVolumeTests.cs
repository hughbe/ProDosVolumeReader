...
public class ProDiskVolumeTests
{
    public static TheoryData<string> DiskImages => new()
    {
        ...
        "archive.org/details/cdrom-golden-orchard-10/GoldenOrchard1.0.iso",
        "archive.org/details/cdrom-golden-orchard-10/02-GO.ProDOS.img",
        "archive.org/details/cdrom-golden-orchard-12/GoldenOrchard1.2.iso",
        "archive.org/details/cdrom-golden-orchard-12/01-GO.ProDOS.img",
