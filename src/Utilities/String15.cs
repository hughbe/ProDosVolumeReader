...
/// <summary>
/// Represents a fixed-size string of up to 15 bytes (e.g., file type, creator codes).
/// </summary>
[InlineArray(Size)]
public struct String15 : ISpanFormattable, IEquatable<String15>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="String15"/> struct.
    /// </summary>
    ...
    public String15(ReadOnlySpan<byte> data)
    {
        if (data.Length != Size)
        {
    ...
    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool Equals(String15 other) =>
        AsReadOnlySpan().SequenceEqual(other.AsReadOnlySpan());

    /// <inheritdoc/>
    public override readonly bool Equals(object? obj) =>
        obj is String15 other && Equals(other);
    ...
    /// <summary>
    /// Determines whether two <see cref="String15"/> instances are equal.
    /// </summary>
    public static bool operator ==(String15 left, String15 right) => left.Equals(right);

    /// <summary>
    /// Determines whether two <see cref="String15"/> instances are not equal.
    /// </summary>
    public static bool operator !=(String15 left, String15 right) => !left.Equals(right);

    /// <summary>
    /// Implicitly converts the <see cref="String15"/> to a <see cref="string"/>.
    /// </summary>
    /// <param name="str">The <see cref="String15"/> instance.</param>
    /// <returns>The converted string.</returns>
    public static implicit operator string(String15 str) => str.ToString();
}
